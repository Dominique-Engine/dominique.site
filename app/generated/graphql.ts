...
export type SocialNetwork = Entity &
    Node & {
...
export type SocialNetworksQuery = {
    __typename?: "Query";
...
export function getSdk(
    ...
    return {
        ...
        Commends(
            variables?: CommendsQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<{
            data: CommendsQuery;
            errors?: GraphQLError[];
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.rawRequest<CommendsQuery>(
                        CommendsDocumentString,
                        variables,
                        {...requestHeaders, ...wrappedRequestHeaders}
                    ),
                "Commends",
        ...
        DocEntries(
            variables?: DocEntriesQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<{
            data: DocEntriesQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.rawRequest<DocEntriesQuery>(
                        DocEntriesDocumentString,
                        variables,
                        {...requestHeaders, ...wrappedRequestHeaders}
                    ),
                "DocEntries",
        ...
        Features(
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.rawRequest<FeaturesQuery>(
                        FeaturesDocumentString,
                        variables,
                        {...requestHeaders, ...wrappedRequestHeaders}
                    ),
                "Features",
        ...
        Landing(
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.rawRequest<LandingQuery>(
                        LandingDocumentString,
                        variables,
                        {...requestHeaders, ...wrappedRequestHeaders}
                    ),
                "Landing",
        ...
        SocialNetworks(
            variables?: SocialNetworksQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<{
            data: SocialNetworksQuery;
            errors?: GraphQLError[];
            extensions?: any;
            headers: Headers;
            status: number;
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.rawRequest<SocialNetworksQuery>(
                        SocialNetworksDocumentString,
                        variables,
                        {...requestHeaders, ...wrappedRequestHeaders}
                    ),
                "SocialNetworks",
