...
export function Elephant() {
    ...
    const isFlipped = mPos.xNormalized > 0.5 ? -1 : 1;
    const EYE_MOVE_FACTOR_X = 50;
    ...
    return (
        <svg
            ...
            style={{
                transform: `scaleX(${isFlipped})`,
            }}
        >
            <g>
                <g>
                    <path
                        d="M420.693,87.526c-27.671,0-46.059,7.964-57.294,15.53c-4.383-3.857-9.119-7.423-14.229-10.677
    ...
    c10.637,10.017,16.738,23.52,16.738,37.043C480.653,186.66,474.557,193.231,460.769,206.746z"
            ...
            <g
                ...
                style={{
                    transform: `translate(${(mPos.xNormalized - 0.5) * EYE_MOVE_FACTOR_X * isFlipped}px, ${(mPos.yNormalized - 0.5) * EYE_MOVE_FACTOR_Y}px)`,
                }}
            >
                <g>
                    <g>
                        <path
                            d="M214.21,179.104c-9.905,0-17.94,8.131-17.94,18.164c0,10.032,8.034,18.165,17.94,18.165
			c9.893,0,17.927-8.132,17.927-18.165C232.138,187.236,224.103,179.104,214.21,179.104z"
                ...
                <g>
                    <g>
                        <path
                            d="M297.802,179.104c-9.905,0-17.94,8.131-17.94,18.164c0,10.032,8.034,18.165,17.94,18.165
